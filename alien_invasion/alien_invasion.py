...
class AlienInvasion:
	...
	def __init__(self):
		...
		self.settings = Settings() #create an instance of class Settings
	...
	def _check_keydown_events(self, event):
		...
		elif event.key == pygame.K_LEFT: # right arrow key
	...
	def _check_bullet_alien_collisions(self):
		...
		if not self.aliens: # check whether aliens group is empty - empty = False
	...
	def _update_screen(self):
		...
		for bullet in self.bullets.sprites():
			bullet.draw_bullet()
		self.aliens.draw(self.screen) # Drawn at rect() attribute
